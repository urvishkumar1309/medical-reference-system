...
namespace webapp.Helpers
{
    public static class CookieHelper
    {
        ...
        ///     Deletes all cookies.
        /// </summary>
        /// <param name="deleteServerCookies">
        ///     True to delete server cookies.
        ...
        private static int GetDefaultDurationValue()
        {
            ...
            if (!string.IsNullOrEmpty(setting)) int.TryParse(setting, out duration);
        ...
        private static bool GetDefaultIsHttpValue()
        {
            ...
            if (!string.IsNullOrEmpty(setting)) bool.TryParse(setting, out isHttp);
